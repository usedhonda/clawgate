...
export default {
  ...
  firstTime: [
    ...
    "  LINE updates are milestone-based only: blocking risk and final wrap-up.",
    "  Kickoff/question/mid-loop chatter must stay in-session (not LINE).",
  ...
  completion: {
    ...
    autonomous: [
      ...
      "Text outside tags is for user-facing milestone summaries only (risk/final). Never send one-word acknowledgements.",
  ...
  question: {
    ...
    autonomous: [
      ...
      "In autonomous mode, do not send question chatter to LINE.",
